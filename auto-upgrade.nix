...
in
{
  ...
  options = {
    ...
    system.autoUpgradeFlake = {
      ...
      flake-dir = lib.mkOption {
        type = lib.types.str;
        example = "/path/to/your/repo/nixos/my-machine";
        description = ''
  ...
  config = lib.mkIf cfg.enable {
    ...
    systemd.services.flake-upgrade = {
      ...
      script = ''
          ${nix-flake-upgrade}/bin/nix-flake-upgrade ${toString (cfg.nix-flake-upgrade-flags)} ${cfg.flake-dir} -- ${toString cfg.flags}
        '';
    ...
    systemd.services.nixos-upgrade = {
      ...
      script =
        let
          ...
          flags = cfg.flags ++ [ "--flake ${cfg.flake-dir}" ];
        in
